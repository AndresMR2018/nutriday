...
<div class="page-header">
  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">Datos Dietas</h4>
      <div class="row">
        <div class="col-12">
            ...
            <table id="order-listing" class="table">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                      <a title="Ver más" data-toggle="modal" data-target="#exampleModal-3{{$dieta->id}}" class="btn btn-outline-info"><i class="fa fa-eye"></i></a>
